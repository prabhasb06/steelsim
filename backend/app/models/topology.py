...
class ComponentClass(str, Enum):
    ...
    LADLE_REFINING_FURNACE = "LADLE_REFINING_FURNACE"
    CONTINUOUS_CASTING_MACHINE = "CONTINUOUS_CASTING_MACHINE"
    ROLLING_MILL = "ROLLING_MILL"
    TMT_QUENCHING_BOX = "TMT_QUENCHING_BOX"
    UTILITY_SUBSTATION = "UTILITY_SUBSTATION"
    WATER_COOLING_SYSTEM = "WATER_COOLING_SYSTEM"
